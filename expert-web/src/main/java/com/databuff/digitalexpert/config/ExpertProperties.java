...
public class ExpertProperties {
    ...
    public static class Agent {
        ...
        private List<String> skillsOutput = new ArrayList<String>();
    }
    ...
    public static class Cors {
        ...
        private List<String> allowedOriginPatterns = new ArrayList<String>(List.of("*"));

        private List<String> allowedMethods = new ArrayList<String>(List.of("GET", "POST", "PUT", "DELETE", "OPTIONS"));

        private List<String> allowedHeaders = new ArrayList<String>(List.of("*"));

        private List<String> exposedHeaders = new ArrayList<String>(List.of("Content-Disposition"));
