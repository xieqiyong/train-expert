...
CREATE TABLE IF NOT EXISTS `expert_release_task` (
  ...
  `active_task_key` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '运行中任务锁键',
...
CREATE TABLE IF NOT EXISTS `expert_training_task` (
  ...
  `manifest_path` text COLLATE utf8mb4_unicode_ci COMMENT '训练产物清单文件路径',
  ...
  UNIQUE KEY `uk_training_active_task` (`active_task_key`),
